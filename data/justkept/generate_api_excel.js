...
const BASE_URL_with_https = 'https://justkept-dev.freewillsolutions.com';
...
const apiTestFlow = {
  ...
  "Login_Flow": [
    ...
    { Action: "SET_BASE_URL", Target: BASE_URL_with_https },
  ...
  "Customer_FindProfile": [
    ...
    { Action: "CHECK_JSON", Target: "0.PK|9876543210987", Data: "pass" }
  ],
  ...
  // npx playwright test test/sa_api_driven.spec.js --workers=1 -g "Login_Flow|Customer_FindDocument"
  // ═══════════════════════════════════════════════════════════════════════════
  "Customer_FindDocument": [
    ...
    { Action: "CHECK_JSON", Target: "data.length|0", Data: "fail" }
  ],
  ...
  "Customer_FindRequest": [
    ...
    { Action: "CHECK_JSON", Target: "0.PK|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.entity|customer_req", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.requestId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.subCompanyId|undefined", Data: "fail" }
  ],
  ...
  "Customer_FindDocFromRequest": [
    ...
    { Action: "LOG_RESPONSE", Target: "1500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },

    { Action: "CHECK_JSON", Target: "data.0.PK|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.0.sourceSystem|BROKER_MANUAL_UPLOAD", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.0.fileName|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.0.requestId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.0.filePath|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.0.docType|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.0.docId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.0.SK_SORT|undefined", Data: "fail" }
  ],
  ...
  "Customer_FindRequestTopic": [
    ...
    { Action: "LOG_RESPONSE", Target: "5500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },

    { Action: "CHECK_JSON", Target: "0.entity|req_topic", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.PK|BKK01", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.req_topic_id|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.config|undefined", Data: "fail" }
  ],
  ...
  "Customer_FindNotification": [
    ...
    { Action: "CHECK_JSON", Target: "data.0.PK|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.0.entity|notification", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.0.isRead|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.0.title|undefined", Data: "fail" },
  ],
  ...
  "Customer_CreateRequest": [
    ...
    // เก็บค่า requestId ลงตัวแปร REQUEST_ID
    { Action: "STORE_JSON", Target: "result.0.requestId", Data: "REQUEST_ID" },
    { Action: "CHECK_JSON", Target: "result.0.customerId|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "result.0.entity|doc_metadata", Data: "pass" },
    { Action: "CHECK_JSON", Target: "result.0.SK_SORT|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "result.0.requestId|undefined", Data: "fail" },
  ],
  ...
  "Broker_FindSchedules": [
    ...
    { Action: "API_POST", Target: "/api/broker/findschedules", Data: '{"brokerId":"U1001"}' },
    { Action: "LOG_RESPONSE", Target: "1500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },

    { Action: "CHECK_JSON", Target: "items.0.brokerId|U1001", Data: "pass" },
    { Action: "CHECK_JSON", Target: "items.0.PK|BKK01", Data: "pass" },
    { Action: "CHECK_JSON", Target: "items.0.entity|system_schedule_job", Data: "pass" },
    { Action: "CHECK_JSON", Target: "items.0.recipientCount|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.secretKey|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.subject|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.runAt|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.nextRunAt|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.stopAt|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.secretName|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.createdAt|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.sourceType|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.sourcePath|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.frequency|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.jobId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.docType|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.dayOfMonth|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.displayRecipientName|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.jobStatus|undefined", Data: "fail" }
  ],
  ...
  "Broker_FindAllCustomer": [
    ...
    { Action: "API_POST", Target: "/api/broker/findallcustomerbysubcomid", Data: '{"brokerId":"U1001", "cardId": "1100100123456"}' },
    { Action: "LOG_RESPONSE", Target: "1500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },

    { Action: "CHECK_JSON", Target: "0.ID_Number|1100100123456", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.entity|relationship", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.PK|customer_relationship", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.customerIdGSIPK|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.customerName|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.email|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.pendingReq|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.status|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.subCompanyId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.totalDocuments|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.updatedAt|undefined", Data: "fail" },
  ],
  ...
  "Broker_FindAllRequested": [
    ...
    { Action: "CHECK_JSON", Target: "items.0.subCompanyId|BKK01", Data: "pass" },
    { Action: "CHECK_JSON", Target: "items.0.entity|customer_req", Data: "pass" },
    { Action: "CHECK_JSON", Target: "items.0.requestId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "items.0.requestTopic|undefined", Data: "fail" },
  ],
  ...
  "Notification_SendFirebase": [
    ...
    { Action: "CHECK_JSON", Target: "messageCode|success", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.entity|notification", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.PK|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.status|SENT", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.customerId|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.notiChannel|On Web", Data: "pass" },
  ],
  ...
  "S3_GetObject": [
    ...
    { Action: "API_POST", Target: "/api/s3/getobject", Data: '{"fileKey":"document/CUSTOMER/9876543210987/basic-text.pdf"}' },
    { Action: "LOG_RESPONSE", Target: "1500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },
  ],
  ...
  "Broker_ListUploadDraft": [
    ...
    { Action: "API_POST", Target: "/api/broker/listuploaddraft", Data: JSON.stringify({ brokerId: "U1001", requestId: "fa00fc86-20e6-463f-8f98-6ad112107d9d" }) },
    { Action: "LOG_RESPONSE", Target: "1500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },

    { Action: "CHECK_JSON", Target: "0.PK|U1001", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.entity|doc_draft", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.requestId|fa00fc86-20e6-463f-8f98-6ad112107d9d", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.customerId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.createdAt|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.docType|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.draftId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.emailTemplate|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.messageBody|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.subjectLine|undefined", Data: "fail" }
  ],
  ...
  "Broker_DeleteDocumentDraft": [
    ...
    {
      Action: "API_POST", Target: "/api/broker/deletedocumentdraft",
      Data: JSON.stringify({ brokerId: "12345678910", draftSK: "DRAFT_DOC#2026-03-24T06:20:31.353Z#DRAFT-3BC5BCDF" })
    },
    { Action: "LOG_RESPONSE", Target: "1500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },

    { Action: "CHECK_JSON", Target: "messageCode|success", Data: "pass" },
    { Action: "CHECK_JSON", Target: "message|undefined", Data: "fail" },
  ],
  ...
  "Broker_CreateDocumentDraft": [
    ...
    { Action: "STORE_JSON", Target: "draftSK", Data: "draft_SK" },
    { Action: "CHECK_JSON", Target: "messageCode|success", Data: "pass" },
    { Action: "CHECK_JSON", Target: "message|undefined", Data: "fail" }
  ],
  ...
  "Document_FindRequestByReqId": [
    ...
    { Action: "CHECK_JSON", Target: "messageCode|success", Data: "pass" },
    { Action: "CHECK_JSON", Target: "message|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.entity|customer_req", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.customerId|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.requestId|2f70d0ec-f6f1-4ffb-aca3-fc93ea50749e", Data: "pass" },
    { Action: "CHECK_JSON", Target: "data.detail|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.fileNonRequiredPath|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.status|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.specifyDocType|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.requestTopic|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.subCompanyId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.isDraft|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.subCompanyId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.requestType|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.updatedAt|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "data.fileRequiredPath|undefined", Data: "fail" }
  ],
  ...
  "Broker_ListScheduleDraft": [
    ...
    { Action: "API_POST", Target: "/api/broker/listscheduledraft", Data: JSON.stringify({ brokerId: "U1001" }) },
    { Action: "LOG_RESPONSE", Target: "1500" },
    { Action: "CHECK_STATUS", Target: "200", Data: "pass" },
  ],
  ...
  "Broker_CustomerLogs": [
    ...
    { Action: "CHECK_JSON", Target: "0.actorId|9876543210987", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.entity|audit_log", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.targetId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.auditId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.actorId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.actorRole|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.action|undefined", Data: "fail" },
  ],
  ...
  "Broker_FindAllCusBySubComId": [
    ...
    { Action: "CHECK_JSON", Target: "0.PK|customer_relationship", Data: "pass" },
    { Action: "CHECK_JSON", Target: "0.customerName|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.ID_Number|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.subCompanyId|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.status|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.pendingReq|undefined", Data: "fail" },
    { Action: "CHECK_JSON", Target: "0.totalDocuments|undefined", Data: "fail" },
